    ...
    public partial class INITIALDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Brands", x => x.Brand);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CancelledProducts", x => x.TransactionNo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Reorder = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Stockonhand = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Entry_Quantity = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnhandProducts", x => x.PCODE);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SoldProduct", x => x.PCODE);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorList", x => x.Vendor);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnhandProductsPCODE = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_OnhandProducts_OnhandProductsPCODE",
                        column: x => x.OnhandProductsPCODE,
                        principalTable: "OnhandProducts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_OnhandProductsPCODE",
                table: "AspNetUsers",
                column: "OnhandProductsPCODE");
